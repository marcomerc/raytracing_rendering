...
vec3 Camera::World_Position(const ivec2& pixel_index) // done
{   TODO;
    vec3 result;
    vec2 C= this->Cell_Center(pixel_index); // obtaining the pixel  center
    result= this->film_position + horizontal_vector*C[0]+ vertical_vector*C[1]; // computing the world posiition
